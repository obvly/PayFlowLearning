...
import com.obvly.payflow.auditservice.audit.dto.AuditEventPageResponse;
import com.obvly.payflow.auditservice.audit.dto.AuditEventResponse;
...
public class AuditEventController {
    ...
    private String normalizeStatus(String status) {
        ...
        try {
            return PaymentStatus.valueOf(status.toUpperCase(Locale.ROOT)).name();
        } catch (IllegalArgumentException exception) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Unknown payment status");
        }
    }
